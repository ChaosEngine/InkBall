...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "concaveman", function() { return _AIBundle$concaveman; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GraphAI", function() { return _AIBundle$GraphAI; });
...
var AIBundle = function (t) {
  ...
  function h(t, n, r) {
    ...
    for (var g = n * n, x = r * r; s.length;) {
      ...
      if (!(y < x)) {
        var B = y / g;
        (l = u(a, _.prev.p, X, Y, _.next.next.p, B, c)) && Math.min(v(l, X), v(l, Y)) <= B && (s.push(_), s.push(d(l, _)), a.remove(l), c.remove(_), c.insert(m(_)), c.insert(m(_.next)));
      }
    }
  ...
  function u(t, n, r, e, o, a, h) {
    for (var u = new i([], s), l = t.data; l;) {
      ...
      for (; u.length && !u.peek().node.children;) {
        ...
        if (v.dist < M && v.dist < _ && c(r, x, h) && c(e, x, h)) return x;
      }
  ...
  function f(t, n, r) {
    ...
    var e = x(t[0], t[1], n[0], n[1], r.minX, r.minY, r.maxX, r.minY);
    if (0 === e) return 0;
    var i = x(t[0], t[1], n[0], n[1], r.minX, r.minY, r.minX, r.maxY);
    if (0 === i) return 0;
    var o = x(t[0], t[1], n[0], n[1], r.maxX, r.minY, r.maxX, r.maxY);
    if (0 === o) return 0;
    var a = x(t[0], t[1], n[0], n[1], r.minX, r.maxY, r.maxX, r.maxY);
  ...
  function x(t, n, r, e, i, o, a, h) {
    ...
    0 === y ? (s = 0, B = 1, l = Y, b = _) : (l = x * Y - M * X, (s = M * Y - _ * X) < 0 ? (s = 0, l = Y, b = _) : s > B && (s = B, l = Y + M, b = _)), l < 0 ? (l = 0, -X < 0 ? s = 0 : -X > x ? s = B : (s = -X, B = x)) : l > b && (l = b, -X + M < 0 ? s = 0 : -X + M > x ? s = B : (s = -X + M, B = x));
    var A = (1 - (f = 0 === l ? 0 : l / b)) * i + f * a - ((1 - (u = 0 === s ? 0 : s / B)) * t + u * r),
        S = (1 - f) * o + f * h - ((1 - u) * n + u * e);
    return A * A + S * S;
  }
  ...
  function r(t, n, r) {
    ...
    var e,
        ...
        s,
        f = [0, 0];
    return e = t[1][1] - t[0][1], i = t[0][0] - t[1][0], o = e * t[0][0] + i * t[0][1], a = n[1][1] - n[0][1], h = n[0][0] - n[1][0], u = a * n[0][0] + h * n[0][1], Y(s = e * h - a * i, 0, r) || (f[0] = (h * o - i * u) / s, f[1] = (e * u - a * o) / s), f;
  }
  ...
  t.exports = {
    decomp: function decomp(t) {
      var n = function t(n) {
        for (var r = [], e = [], i = [], o = [], a = Number.MAX_VALUE, h = 0; h < n.length; ++h) {
          if (d(n, h)) for (var u = 0; u < n.length; ++u) {
            if (x(n, h, u)) {
              e = t(_(n, h, u, o)), i = t(_(n, u, h, o));
      ...
      return n.length > 0 ? function t(n, r) {
        ...
        return -1 !== i && -1 !== a && [_(n, i, a), _(n, a, i)];
      }(t, n) : [t];
    },
    quickDecomp: function t(n, r, e, i, s, f, l) {
      f = f || 100, l = l || 0, s = s || 25, r = void 0 !== r ? r : [], e = e || [], i = i || [];
      var v = [0, 0],
          g = [0, 0],
          x = [0, 0],
          _ = 0,
      ...
      if (++l > f) return console.warn("quickDecomp: max level (" + f + ") reached."), r;

      for (var O = 0; O < n.length; ++O) {
        if (d(P, O)) {
          e.push(P[O]), _ = Y = Number.MAX_VALUE;

          for (var $ = 0; $ < n.length; ++$) {
            o(p(P, O - 1), p(P, O), p(P, $)) && u(p(P, O - 1), p(P, O), p(P, $ - 1)) && (x = X(p(P, O - 1), p(P, O), p(P, $), p(P, $ - 1)), h(p(P, O + 1), p(P, O), x) && (y = c(P[O], x)) < Y && (Y = y, g = x, A = $)), o(p(P, O + 1), p(P, O), p(P, $ + 1)) && u(p(P, O + 1), p(P, O), p(P, $)) && (x = X(p(P, O + 1), p(P, O), p(P, $), p(P, $ + 1)), o(p(P, O - 1), p(P, O), x) && (y = c(P[O], x)) < _ && (_ = y, v = x, b = $));
          }

          if (A === (b + 1) % n.length) x[0] = (g[0] + v[0]) / 2, x[1] = (g[1] + v[1]) / 2, i.push(x), O < b ? (m(w, P, O, b + 1), w.push(x), I.push(x), 0 !== A && m(I, P, A, P.length), m(I, P, 0, O + 1)) : (0 !== O && m(w, P, O, P.length), m(w, P, 0, b + 1), w.push(x), I.push(x), m(I, P, A, O + 1));else {
            if (A > b && (b += n.length), B = Number.MAX_VALUE, b < A) return r;

            for ($ = A; $ <= b; ++$) {
              a(p(P, O - 1), p(P, O), p(P, $)) && u(p(P, O + 1), p(P, O), p(P, $)) && (y = c(p(P, O), p(P, $))) < B && M(P, O, $) && (B = y, S = $ % n.length);
            }

            O < S ? (m(w, P, O, S + 1), 0 !== S && m(I, P, S, G.length), m(I, P, 0, O + 1)) : (0 !== O && m(w, P, O, G.length), m(w, P, 0, S + 1), m(I, P, S, O + 1));
          }
          return w.length < I.length ? (t(w, r, e, i, s, f, l), t(I, r, e, i, s, f, l)) : (t(I, r, e, i, s, f, l), t(w, r, e, i, s, f, l)), r;
        }
      }
    ...
    removeCollinearPoints: function removeCollinearPoints(t, n) {
      for (var r = 0, e = t.length - 1; t.length > 3 && e >= 0; --e) {
        l(p(t, e - 1), p(t, e), p(t, e + 1), n) && (t.splice(e % t.length, 1), r++);
      }
  ...
  function x(t, n, e) {
    ...
    for (var f = 0; f !== t.length; ++f) {
      if ((f + 1) % t.length !== n && f !== n && a(p(t, n), p(t, e), p(t, f + 1)) && u(p(t, n), p(t, e), p(t, f)) && (h[0] = p(t, n), h[1] = p(t, e), s[0] = p(t, f), s[1] = p(t, f + 1), i = r(h, s), c(p(t, n), i) < o)) return !1;
    }
  ...
  function X(t, n, r, e, i) {
    ...
    var o = n[1] - t[1],
        ...
        f = u * r[0] + s * r[1],
        l = o * s - u * a;
    return Y(l, 0, i) ? [0, 0] : [(s * h - a * f) / l, (o * f - u * h) / l];
  }
  ...
  function y(t, n, r) {
    return Y(t[0], n[0], r) && Y(t[1], n[1], r);
  }
}, function (t, n, r) {
  "use strict";

  r.r(n), r.d(n, "GraphAI", function () {
    return h;
  });
  var e = r(0),
      i = r.n(e);
  ...
  var h = /*#__PURE__*/function () {
    function h(t, n, r, e, i, o, a) {
      _classCallCheck(this, h);

      this.m_iGridWidth = t, this.m_iGridHeight = n, this.m_iGridSizeX = r, this.m_iGridSizeY = e, this.PointStore = i, this.POINT_STARTING = o, this.POINT_IN_PATH = a;
    }
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _ref = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, t = _ref.freePointStatus, _ref$fillCol = _ref.fillCol, n = _ref$fillCol === void 0 ? "blue" : _ref$fillCol;
                  r = [], e = new Map(), i = function i(t, r) {
                    var e = r.GetStatus();
                    return !(!t.includes(e) || r.GetFillColor() !== n);
                  }, o = /*#__PURE__*/function () {
                    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(n, o, a, h, u, s, f) {
                      var _h, _t;
                      ...
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              if (!(o >= 0 && o < this.m_iGridWidth && a >= 0 && a < this.m_iGridHeight)) {
                                _context.next = 5;
                                break;
                              }

                              _context.next = 3;
                              return this.PointStore.get(a * this.m_iGridWidth + o);

                            case 3:
                              _h = _context.sent;

                              if (_h && !0 === i([t], _h) && !1 === e.has("".concat(s, ",").concat(f, "_").concat(o, ",").concat(a)) && !1 === e.has("".concat(o, ",").concat(a, "_").concat(s, ",").concat(f))) {
                                _t = {
                                  from: n,
                                  to: _h
                                };
                                if (e.set("".concat(s, ",").concat(f, "_").concat(o, ",").concat(a), _t), !1 === r.includes(n)) n.adjacents = [_h], r.push(n);else {
                                  r.find(function (t) {
                                    return t === n;
                                  }).adjacents.push(_h);
                                }
                                if (!1 === r.includes(_h)) _h.adjacents = [n], r.push(_h);else {
                                  r.find(function (t) {
                                    return t === _h;
                                  }).adjacents.push(n);
                                }
                ...
                case 9:
                  ...
                  if (!(_n && !0 === i([t, this.POINT_STARTING, this.POINT_IN_PATH], _n))) {
                    _context2.next = 29;
                    break;
                  }

                  _n$GetPosition = _n.GetPosition(), _t2 = _n$GetPosition.x, _r = _n$GetPosition.y, _e = _t2 / this.m_iGridSizeX, _i = _r / this.m_iGridSizeY;
                  _context2.next = 15;
                  return o(_n, _e + 1, _i, _t2, _r, _e, _i);
                ...
                case 17:
                  _context2.next = 19;
                  return o(_n, _e, _i - 1, _t2, _r, _e, _i);
                ...
                case 21:
                  _context2.next = 23;
                  return o(_n, _e - 1, _i - 1, _t2, _r, _e, _i);
  ...
  var u = [[484, 480], [676, 363], [944, 342], [678, 41], [286, 237], [758, 215], [752, 117], [282, 492], [609, 262], [129, 252]],
      s = i()(u, 2, 0),
      f = a.a.decomp(u);
  (!s || s.length <= 0 || //!convexPolygonsQuick || convexPolygonsQuick.length <= 0 || 
    ...
    return e.prototype.all = function () {
      ...
      for (var e, i, o, h, u, s, l, c = 1 / 0, p = 1 / 0, m = n; m <= r - n; m++) {
        var d = a(t, 0, m, this.toBBox),
            ...
            g = (i = d, o = v, h = Math.max(i.minX, o.minX), u = Math.max(i.minY, o.minY), s = Math.min(i.maxX, o.maxX), l = Math.min(i.maxY, o.maxY), Math.max(0, s - h) * Math.max(0, l - u)),
            x = f(d) + f(v);
        g < c ? (c = g, e = m, p = x < p ? x : p) : g === c && x < p && (p = x, e = m);
      }
  ...
  !function (t) {
    ...
    t.orient2d = function (t, e, s, f, l, c) {
      ...
      return Math.abs(d) >= 33306690738754716e-32 * v ? d : -function (t, e, s, f, l, c, p) {
        var m, d, v, g, x, M, _, X, Y, y, B, b, A, S, w, I, P, G;

        var O = t - l,
            $ = s - l,
            j = e - c,
            N = f - c;
        x = (w = (X = O - (_ = (M = n * O) - (M - O))) * (y = N - (Y = (M = n * N) - (M - N))) - ((S = O * N) - _ * Y - X * Y - _ * y)) - (B = w - (P = (X = j - (_ = (M = n * j) - (M - j))) * (y = $ - (Y = (M = n * $) - (M - $))) - ((I = j * $) - _ * Y - X * Y - _ * y))), i[0] = w - (B + x) + (x - P), x = (A = S - ((b = S + B) - (x = b - S)) + (B - x)) - (B = A - I), i[1] = A - (B + x) + (x - I), x = (G = b + B) - b, i[2] = b - (G - x) + (B - x), i[3] = G;
        ...
        var T = function (t, n) {
          ...
          return r;
            ...
            E = 22204460492503146e-32 * p;

        if (T >= E || -T >= E) return T;
        if (m = t - (O + (x = t - O)) + (x - l), v = s - ($ + (x = s - $)) + (x - l), d = e - (j + (x = e - j)) + (x - c), g = f - (N + (x = f - N)) + (x - c), 0 === m && 0 === d && 0 === v && 0 === g) return T;
        if (E = 11093356479670487e-47 * p + 33306690738754706e-32 * Math.abs(T), (T += O * g + N * m - (j * v + $ * d)) >= E || -T >= E) return T;
        x = (w = (X = m - (_ = (M = n * m) - (M - m))) * (y = N - (Y = (M = n * N) - (M - N))) - ((S = m * N) - _ * Y - X * Y - _ * y)) - (B = w - (P = (X = d - (_ = (M = n * d) - (M - d))) * (y = $ - (Y = (M = n * $) - (M - $))) - ((I = d * $) - _ * Y - X * Y - _ * y))), u[0] = w - (B + x) + (x - P), x = (A = S - ((b = S + B) - (x = b - S)) + (B - x)) - (B = A - I), u[1] = A - (B + x) + (x - I), x = (G = b + B) - b, u[2] = b - (G - x) + (B - x), u[3] = G;
        var k = r(4, i, 4, u, o);
        x = (w = (X = O - (_ = (M = n * O) - (M - O))) * (y = g - (Y = (M = n * g) - (M - g))) - ((S = O * g) - _ * Y - X * Y - _ * y)) - (B = w - (P = (X = j - (_ = (M = n * j) - (M - j))) * (y = v - (Y = (M = n * v) - (M - v))) - ((I = j * v) - _ * Y - X * Y - _ * y))), u[0] = w - (B + x) + (x - P), x = (A = S - ((b = S + B) - (x = b - S)) + (B - x)) - (B = A - I), u[1] = A - (B + x) + (x - I), x = (G = b + B) - b, u[2] = b - (G - x) + (B - x), u[3] = G;
        var q = r(k, o, 4, u, a);
        x = (w = (X = m - (_ = (M = n * m) - (M - m))) * (y = g - (Y = (M = n * g) - (M - g))) - ((S = m * g) - _ * Y - X * Y - _ * y)) - (B = w - (P = (X = d - (_ = (M = n * d) - (M - d))) * (y = v - (Y = (M = n * v) - (M - v))) - ((I = d * v) - _ * Y - X * Y - _ * y))), u[0] = w - (B + x) + (x - P), x = (A = S - ((b = S + B) - (x = b - S)) + (B - x)) - (B = A - I), u[1] = A - (B + x) + (x - I), x = (G = b + B) - b, u[2] = b - (G - x) + (B - x), u[3] = G;
        var D = r(q, a, 4, u, h);
        return h[D - 1];
      }(t, e, s, f, l, c, v);
...
void 0 === AIBundle && console.error("esm-webpack-plugin: nothing exported!");
var _AIBundle$concaveman = AIBundle.concaveman,
    _AIBundle$GraphAI = AIBundle.GraphAI;
