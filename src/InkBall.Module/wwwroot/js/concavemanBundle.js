...
function concaveman(points, concavity, lengthThreshold) {
  ...
  var tree = rbush(16, ['[0]', '[1]', '[0]', '[1]']).load(points); // turn the convex hull into a linked list and populate the initial edge queue with the nodes
...
function fastConvexHull(points) {
  ...
  var indices = convexHull(filtered); // return the hull as array of points (rather than indices)
...
var concavity = 2.0,
    lengthThreshold = 0.0;
var output = concaveman__WEBPACK_IMPORTED_MODULE_0___default()(precision_points, concavity, lengthThreshold);

if (isTest) {
  var concaveman_output = document.createElement("div");
