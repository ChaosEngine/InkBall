...
var concavemanBundle = function (t) {
  ...
  function h(t, n, r) {
    ...
    for (var x = n * n, g = r * r; f.length;) {
      ...
      if (!(y < g)) {
        var B = y / x;
        (l = u(a, X.prev.p, Y, _, X.next.next.p, B, s)) && Math.min(d(l, Y), d(l, _)) <= B && (f.push(X), f.push(v(l, X)), a.remove(l), s.remove(X), s.insert(m(X)), s.insert(m(X.next)));
      }
    }
  ...
  function g(t, n, r, e, i, o, a, h) {
    ...
    0 === y ? (f = 0, B = 1, l = _, b = X) : (l = g * _ - M * Y, (f = M * _ - X * Y) < 0 ? (f = 0, l = _, b = X) : f > B && (f = B, l = _ + M, b = X)), l < 0 ? (l = 0, -Y < 0 ? f = 0 : -Y > g ? f = B : (f = -Y, B = g)) : l > b && (l = b, -Y + M < 0 ? f = 0 : -Y + M > g ? f = B : (f = -Y + M, B = g));
    var O = (1 - (c = 0 === l ? 0 : l / b)) * i + c * a - ((1 - (u = 0 === f ? 0 : f / B)) * t + u * r),
        S = (1 - c) * o + c * h - ((1 - u) * n + u * e);
    return O * O + S * S;
  }
  ...
  function r(t, n, r) {
    ...
    var e,
        ...
        f,
        c = [0, 0];
    return e = t[1][1] - t[0][1], i = t[0][0] - t[1][0], o = e * t[0][0] + i * t[0][1], a = n[1][1] - n[0][1], h = n[0][0] - n[1][0], u = a * n[0][0] + h * n[0][1], _(f = e * h - a * i, 0, r) || (c[0] = (h * o - i * u) / f, c[1] = (e * u - a * o) / f), c;
  }
    ...
    quickDecomp: function t(n, r, e, i, f, c, l) {
      ...
      for (var P = 0; P < n.length; ++P) {
        if (v(j, P)) {
          ...
          if (O === (b + 1) % n.length) g[0] = (x[0] + d[0]) / 2, g[1] = (x[1] + d[1]) / 2, i.push(g), P < b ? (m(w, j, P, b + 1), w.push(g), A.push(g), 0 !== O && m(A, j, O, j.length), m(A, j, 0, P + 1)) : (0 !== P && m(w, j, P, j.length), m(w, j, 0, b + 1), w.push(g), A.push(g), m(A, j, O, P + 1));else {
            ...
            P < S ? (m(w, j, P, S + 1), 0 !== S && m(A, j, S, E.length), m(A, j, 0, P + 1)) : (0 !== P && m(w, j, P, E.length), m(w, j, 0, S + 1), m(A, j, S, P + 1));
          }
          return w.length < A.length ? (t(w, r, e, i, f, c, l), t(A, r, e, i, f, c, l)) : (t(A, r, e, i, f, c, l), t(w, r, e, i, f, c, l)), r;
        }
      }
  ...
  function Y(t, n, r, e, i) {
    ...
    var o = n[1] - t[1],
        ...
        c = u * r[0] + f * r[1],
        l = o * f - u * a;
    return _(l, 0, i) ? [0, 0] : [(f * h - a * c) / l, (o * c - u * h) / l];
  }
    ...
    return e.prototype.all = function () {
      ...
      for (var e, i, o, h, u, f, l, s = 1 / 0, p = 1 / 0, m = n; m <= r - n; m++) {
        var v = a(t, 0, m, this.toBBox),
            ...
            x = (i = v, o = d, h = Math.max(i.minX, o.minX), u = Math.max(i.minY, o.minY), f = Math.min(i.maxX, o.maxX), l = Math.min(i.maxY, o.maxY), Math.max(0, f - h) * Math.max(0, l - u)),
            g = c(v) + c(d);
  ...
  !function (t) {
    ...
    t.orient2d = function (t, e, f, c, l, s) {
      ...
      return Math.abs(v) >= 33306690738754716e-32 * d ? v : -function (t, e, f, c, l, s, p) {
        var m, v, d, x, g, M, X, Y, _, y, B, b, O, S, w, A, j, E;

        var P = t - l,
            k = f - l,
            q = e - s,
            D = c - s;
        g = (w = (Y = P - (X = (M = n * P) - (M - P))) * (y = D - (_ = (M = n * D) - (M - D))) - ((S = P * D) - X * _ - Y * _ - X * y)) - (B = w - (j = (Y = q - (X = (M = n * q) - (M - q))) * (y = k - (_ = (M = n * k) - (M - k))) - ((A = q * k) - X * _ - Y * _ - X * y))), i[0] = w - (B + g) + (g - j), g = (O = S - ((b = S + B) - (g = b - S)) + (B - g)) - (B = O - A), i[1] = O - (B + g) + (g - A), g = (E = b + B) - b, i[2] = b - (E - g) + (B - g), i[3] = E;
        ...
        if (N >= C || -N >= C) return N;
        if (m = t - (P + (g = t - P)) + (g - l), d = f - (k + (g = f - k)) + (g - l), v = e - (q + (g = e - q)) + (g - s), x = c - (D + (g = c - D)) + (g - s), 0 === m && 0 === v && 0 === d && 0 === x) return N;
        if (C = 11093356479670487e-47 * p + 33306690738754706e-32 * Math.abs(N), (N += P * x + D * m - (q * d + k * v)) >= C || -N >= C) return N;
        g = (w = (Y = m - (X = (M = n * m) - (M - m))) * (y = D - (_ = (M = n * D) - (M - D))) - ((S = m * D) - X * _ - Y * _ - X * y)) - (B = w - (j = (Y = v - (X = (M = n * v) - (M - v))) * (y = k - (_ = (M = n * k) - (M - k))) - ((A = v * k) - X * _ - Y * _ - X * y))), u[0] = w - (B + g) + (g - j), g = (O = S - ((b = S + B) - (g = b - S)) + (B - g)) - (B = O - A), u[1] = O - (B + g) + (g - A), g = (E = b + B) - b, u[2] = b - (E - g) + (B - g), u[3] = E;
        var L = r(4, i, 4, u, o);
        g = (w = (Y = P - (X = (M = n * P) - (M - P))) * (y = x - (_ = (M = n * x) - (M - x))) - ((S = P * x) - X * _ - Y * _ - X * y)) - (B = w - (j = (Y = q - (X = (M = n * q) - (M - q))) * (y = d - (_ = (M = n * d) - (M - d))) - ((A = q * d) - X * _ - Y * _ - X * y))), u[0] = w - (B + g) + (g - j), g = (O = S - ((b = S + B) - (g = b - S)) + (B - g)) - (B = O - A), u[1] = O - (B + g) + (g - A), g = (E = b + B) - b, u[2] = b - (E - g) + (B - g), u[3] = E;
        var R = r(L, o, 4, u, a);
        g = (w = (Y = m - (X = (M = n * m) - (M - m))) * (y = x - (_ = (M = n * x) - (M - x))) - ((S = m * x) - X * _ - Y * _ - X * y)) - (B = w - (j = (Y = v - (X = (M = n * v) - (M - v))) * (y = d - (_ = (M = n * d) - (M - d))) - ((A = v * d) - X * _ - Y * _ - X * y))), u[0] = w - (B + g) + (g - j), g = (O = S - ((b = S + B) - (g = b - S)) + (B - g)) - (B = O - A), u[1] = O - (B + g) + (g - A), g = (E = b + B) - b, u[2] = b - (E - g) + (B - g), u[3] = E;
        var U = r(R, a, 4, u, h);
        return h[U - 1];
      }(t, e, f, c, l, s, d);
...
void 0 === concavemanBundle && console.error("esm-webpack-plugin: nothing exported!");
