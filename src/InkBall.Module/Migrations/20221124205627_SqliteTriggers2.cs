...
namespace InkBall.Module.Migrations
{
    public partial class SqliteTriggers2 : Migration
    {
		...
		{
			//sadly Sqlite can drop already created drigger, 'coz when changing primary keys it WILL recreate NEW TABLES
		...
		{
            //no-op 'coz this trigger-sqlite-thing should already be applied ealier
